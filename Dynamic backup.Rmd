...
dropdown <- list(
      list(
        ...
        buttons = list(
          ...
          list(method = "restyle",
               args = list("visible", list(FALSE, TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE,FALSE)),
...
OrehaLine <- plot_ly(NOrehaD, x = ~Date, y= ~Close, type = 'scatter', mode = 'lines', name = "Basic Oreha Material") %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
        list(
          count = 7,
...
StoneLine <- plot_ly() %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
        list(
          count = 7,
...
ShardsLine <- plot_ly() %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
        list(
          count = 7,
...
RateupLine <- plot_ly() %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
        list(
          count = 7,
...
# Candle stick graph setup

```{r}
GHLCgraph <- NGHLD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
        list(
          count = 7,
...
OrehaCgraph <- NOrehaD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
DestructionCgraph <- NDestructionD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
GuardianCgraph <- NGuardianD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
SShardCGraph <- NSShardD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
NMShardCGraph <- NMShardD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
NLShardCGraph <- NLShardD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
BlessingCGraph <- NBlessingD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
GraceCGraph <- NGraceD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
ProtectionCGraph <- NProtectionD %>% plot_ly(x = ~Date, type="candlestick",
          open = ~Open, close = ~Close,
          high = ~Max, low = ~Min) %>% layout(updatemenus = updatemenus, hovermode = "x", yaxis = list(title = "Price in gold"),xaxis = list(
    rangeselector = list(
      buttons = list(
...
```{r warning=FALSE, error=FALSE, fig.width= 16}
SuperLine
```
